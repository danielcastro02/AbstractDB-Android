...
public class AbstractBD<E> {
    ...
    public AbstractBD(Activity activity, String apiURL, String remoteAdress, String remoteDb, String remoteUser, String remotePass) {
    ...
    public AbstractBD(Activity activity) {
        this.activity = activity;
    }

    public AbstractBD(Activity activity, String dbName) {
        this.activity = activity;
        this.db = this.activity.getBaseContext().openOrCreateDatabase(dbName + ".db", Context.MODE_PRIVATE, null);
    }
...
//    public void selectRemote(E objet) {
//        this.obj = objet;
//        if (!this.remoteAdress.equals("")) {
//            Log.d("avanco", "1");
//            Thread t = new Thread() {
